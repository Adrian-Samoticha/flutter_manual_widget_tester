...
void main() {
  testWidgets(
    'widget test session handler basic functionality',
    (tester) async {
  ...
  testWidgets(
    'widget test session handler session creation callback',
    (tester) async {
      final sessionHandler = WidgetTestSessionHandler();
  ...
  testWidgets(
    'widget test session handler index change callback',
    (tester) async {
      final sessionHandler = WidgetTestSessionHandler();
  ...
  testWidgets(
    'widget test session handler session custom settings stream '
    'subscriptions (session is closed)',
    (tester) async {
      final sessionHandler = WidgetTestSessionHandler();
