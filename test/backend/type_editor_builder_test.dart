...
void main() {
  testWidgets('type editor builder basic functionality', (tester) async {
    ...
    editorBuilder.installEditorBuilder<String>((String settingName, String text,
    ...
    editorBuilder.buildEditor('some setting', String, 'some value',
        expectAsync1((value) => value == 'new string'));
  });
