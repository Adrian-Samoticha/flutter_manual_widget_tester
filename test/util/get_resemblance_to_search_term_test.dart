...
void main() {
  testWidgets('get resemblance to search term containsCharactersInOrder',
      (tester) async {
    ...
    expect('FZMBGLEWXOVQRHWI'.containsCharactersInOrder('FZBLOHI'.codeUnits),
        true);
    expect('JAVHNXEDBMEVXXZA'.containsCharactersInOrder('JAHDVXZ'.codeUnits),
        true);
    expect('MDFMASXDNFKRZDWZ'.containsCharactersInOrder('FMSDFRD'.codeUnits),
        true);
  ...
  testWidgets('get resemblance to search term getResemblanceToSearchTerm',
      (tester) async {
    ...
    expect(
        'resemblesSearchTerm'.getResemblanceToSearchTerm('resemblessearchterm'),
        closeTo(0.9, epsilon));
    expect('resemblesSearchTerm'.getResemblanceToSearchTerm('resembles'),
        closeTo(0.8, epsilon));
    expect('resemblesSearchTerm'.getResemblanceToSearchTerm('searchterm'),
        closeTo(0.7, epsilon));
    expect('resemblesSearchTerm'.getResemblanceToSearchTerm('rst'),
        closeTo(0.6, epsilon));
    expect('resemblesSearchTerm'.getResemblanceToSearchTerm('asdf'),
        closeTo(0.0, epsilon));
  });
}
